  ...
  return (
    <div>
        ...
        <div className="flex flex-col ml-4">
          ...
          <p>
            <strong>Application</strong> refers to Kalppo, the software
            program provided by the Company.
          </p>

          <p>
            <strong>Company</strong> (referred to as either "the Company", "We",
            "Us" or "Our" in this Agreement) refers to MGSR Technologies, House
            NO - 400, Chira Chas, Bokaro Steel City, Jharkhand, India, PIN -
            827013.
          </p>
          ...
          <p>
            <strong>Service Data</strong> refers to data collected
        ...
        <p>
          ...
          Service users is among the assets transferred. <br />
          ...
          our Service, products, services, marketing and your experience. <br />
        </p>
        ...
        <p>
          By email: hello@kalppo.com <br />
          By phone number: +91 9632848570
        </p>
