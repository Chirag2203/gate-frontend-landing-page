  ...
  return (
    <div>
      ...
      <div className="px-4 sm:px-16 mt-8 sm:mt-12 2xl:px-32">
        <p className="text-3xl font-bold text-primary">Terms and Conditions</p>
        <>
          <p>
            <br />
          </p>
          ...
          <p>
            <span style={{ fontSize: "12pt" }}>
              We are Kalppo, doing business as MGSR Technologies ("Company,"
              "we," "us," "our", a company registered in India at House NO -
              400, Chira Chas, Bokaro Steel City, Jharkhand 827013.
            </span>
          </p>
          <p>
            <span style={{ fontSize: "12pt" }}>
              We operate the website http://www.kalppo.com (the "Site"), as
          ...
          <p>
            <span style={{ fontSize: "12pt" }}>
              You can contact us by phone at +919632848570, email at
              hello@kalppo.com, or by mail to House NO - 400, Chira Chas,
              Bokaro Steel City, Jharkhand 827013, India.
            </span>
          </p>
          <p>
            <br />
          ...
          <p>
            <span style={{ fontSize: "12pt" }}>
              ...
              ("you'*), and Kalppo, concerning your access to and use of the
          ...
          <p>
            <span style={{ fontSize: "12pt" }}>
              ...
              effective upon posting or notifying you by hello@kalppo.com, as
          ...
          <p>
            <strong>
              <span style={{ fontSize: "12pt" }}>1. OUR SERVICES</span>
            </strong>
          </p>
          <p>
            <br />
          ...
          <p>
            <span style={{ fontSize: "12pt" }}>
              ...
              competition laks) and treaties in the United States and around the
              world.
            </span>
          </p>
          <p>
          ...
          <p>
            <strong>
              <span style={{ fontSize: "12pt" }}>Your use of our Services</span>
            </strong>
          </p>
          <p>
            <br />
          ...
          <p>
            <span style={{ fontSize: "12pt" }}>• access the Services; and</span>
          </p>
          <p>
            <span style={{ fontSize: "12pt" }}>
          ...
          <p>
            <span style={{ fontSize: "12pt" }}>
              ...
              Terms, please address your request to: hello@kalppo.com. If we
          ...
          <p>
            <strong>
              <span style={{ fontSize: "12pt" }}>Your submissions</span>
            </strong>
          </p>
          <p>
            <br />
          ...
          <p>
            <strong>
              <span style={{ fontSize: "12pt" }}>3. USER REPRESENTATIONS</span>
            </strong>
          </p>
          <p>
            <br />
          ...
          <p>
            <strong>
              <span style={{ fontSize: "12pt" }}>4. USER REGISTRATION</span>
            </strong>
          </p>
          <p>
            <br />
          ...
          <p>
            <strong>
              <span style={{ fontSize: "12pt" }}>5. PURCHASES AND PAYMENT</span>
            </strong>
          </p>
          <p>
            <br />
          ...
          <p>
            <span style={{ fontSize: "12pt" }}>
              We accept the following forms of payment: UPI, Internet Banking
            </span>
          </p>
          <p>
            <br />
          ...
          <p>
            <strong>
              <span style={{ fontSize: "12pt" }}>6. PROHIBITED ACTIVITIES</span>
            </strong>
          </p>
          <p>
            <br />
          ...
          <p>
            <span style={{ fontSize: "12pt" }}>
              ...
              of capital letters ad spamming (continuous posting of repetitive
          ...
          <p>
            <span style={{ fontSize: "12pt" }}>
              • Attempt to impersonate another user or person or use the usemame
              of another user.
            </span>
          </p>
          <p>
          ...
          <p>
            <strong>
              <span style={{ fontSize: "12pt" }}>8. CONTRIBUTION LICENSE</span>
            </strong>
          </p>
          <p>
            <br />
          ...
          <p>
            <strong>
              <span style={{ fontSize: "12pt" }}>9. SERVICES MANAGEMENT</span>
            </strong>
          </p>
          <p>
            <br />
          ...
          <p>
            <strong>
              <span style={{ fontSize: "12pt" }}>10. PRIVACY POLICY</span>
            </strong>
          </p>
          <p>
            <br />
          ...
          <p>
            <span style={{ fontSize: "12pt" }}>
              ...
              Please be advised the Services are hosted in India. If you access
          ...
          <p>
            <strong>
              <span style={{ fontSize: "12pt" }}>11. TERM AND TERMINATION</span>
            </strong>
          </p>
          <p>
            <br />
          ...
          <p>
            <strong>
              <span style={{ fontSize: "12pt" }}>13. GOVERNING LAW</span>
            </strong>
          </p>
          <p>
            <br />
          ...
          <p>
            <span style={{ fontSize: "12pt" }}>
              Kalppo and yourself irrevocably consent that the courts of India
              shall have exclusive jurisaction to resolve any dispute which may
          ...
          <p>
            <strong>
              <span style={{ fontSize: "12pt" }}>14. DISPUTE RESOLUTION</span>
            </strong>
          </p>
          <p>
            <br />
          ...
          <p>
            <span style={{ fontSize: "12pt" }}>
              ...
              Terms to the jurisdiction of the India courts.
            </span>
          </p>
          <p>
            <span style={{ fontSize: "12pt" }}>
              Kalppo shall also maintain the right to bring proceedings as to
          ...
          <p>
            <strong>
              <span style={{ fontSize: "12pt" }}>15. CORRECTIONS</span>
            </strong>
          </p>
          <p>
            <br />
          ...
          <p>
            <strong>
              <span style={{ fontSize: "12pt" }}>16. DISCLAIMER</span>
            </strong>
          </p>
          <p>
            <br />
          ...
          <p>
            <strong>
              <span style={{ fontSize: "12pt" }}>18. INDEMNIFICATION</span>
            </strong>
          </p>
          <p>
            <br />
          ...
          <p>
            <strong>
              <span style={{ fontSize: "12pt" }}>19. USER DATA</span>
            </strong>
          </p>
          <p>
            <br />
          ...
          <p>
            <span style={{ fontSize: "12pt" }}>
              We wil maintain certain data that you transmit to the Services for
              ...
              have undertaken using the Services. You agree that we shall have
          ...
          <p>
            <strong>
              <span style={{ fontSize: "12pt" }}>21. MISCELLANEOUS</span>
            </strong>
          </p>
          <p>
            <br />
          ...
          <p>
            <span style={{ fontSize: "12pt" }}>
              ...
              entire agreement and understanding between you and us. Our fallure
              to exercise or enforce any right i provision of these Legal Terms
              shall not operate as a waiver of such right or provision. These
              Legal Terms operate to the fullest extent permissible by law. We
              may assign any or all lof our rights and obligations to others at
              any time. We shall not be responsible or liable for any loss,
              damage, delay, or failure to act caused by any cause beyond our
              neasonable control. If any provision or part of a provision of
          ...
          <p>
            <strong>
              <span style={{ fontSize: "12pt" }}>22. CONTACT US</span>
            </strong>
          </p>
          <p>
            <br />
          ...
          <p>
            <span style={{ fontSize: "12pt" }}>Kalppo</span>
          </p>
          <p>
            <span style={{ fontSize: "12pt" }}>House NO - 400</span>
          </p>
          <p>
            <span style={{ fontSize: "12pt" }}>Chira Chas</span>
          </p>
          <p>
            <span style={{ fontSize: "12pt" }}>
          ...
          <p>
            <span style={{ fontSize: "12pt" }}>India</span>
          </p>
          <p>
            <span style={{ fontSize: "12pt" }}>Phone: +919632848570</span>
          </p>
          <p>
            <span style={{ fontSize: "12pt" }}>hello@kalppo.com</span>
          </p>
          <p>
            <br />
          </p>
