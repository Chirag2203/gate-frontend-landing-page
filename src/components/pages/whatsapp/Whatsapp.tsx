    ...
    return (
        <div>
            ...
            <motion.div variants={{
                ...
                viewport={{ once: true }}
                className="pb-52 w-full flex flex-col items-center justify-start mt-16 relative
        bg-center bg-no-repeat bg-cover"
            ...
            <div className="px-4 sm:px-16 mt-8 sm:mt-24 2xl:px-32 min-h-screen flex flex-col gap-24">
                <motion.div variants={{
                    ...
                    whileInView="visible"
                    transition={{ duration: 1, delay: 0.1 }}
                    viewport={{ once: true }} className="flex flex-col sm:flex-row items-center justify-center gap-12">
                ...
                <motion.div variants={{
                    ...
                    whileInView="visible"
                    transition={{ duration: 1, delay: 0.1 }}
                    viewport={{ once: true }} className="flex border rounded-xl sm:flex-row flex-col border-primary sm:gap-32 gap-4    p-4 sm:p-16 mt-8 sm:mt-24 items-center justify-around bg-blue-50">
                    <div className="flex flex-col gap-8 sm:items-start items-center">
                        ...
                        <div className="flex gap-4">
                            <Link to={"https://wa.me/message/AZBPWRR2G4ZRO1"}>
                                <Button className="py-5 px-24 border border-green-600 hover:border-green-900 bg-green-600 text-white" variant={"whatsapp"}><FaWhatsapp />Ask on WhatsApp</Button>
                            </Link>
