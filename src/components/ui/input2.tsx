    ...
    return (
      ...
      >
        <input
          type={type}
          className={cn(
            `flex h-10 w-full border-input hover:bg-gray-50 dark:bg-zinc-800 text-black dark:text-white shadow-input rounded-sm px-3 py-2 text-sm  file:border-0 file:bg-transparent 
