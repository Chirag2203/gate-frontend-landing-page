...
import eleven from "@/assets/recommended/11.png"
import twelve from "@/assets/recommended/12.png"
import thirteen from "@/assets/recommended/13.png"

export const setOne = [one, two, four, five, six, seven, eight]
export const setTwo = [nine, ten, eleven, twelve, thirteen]