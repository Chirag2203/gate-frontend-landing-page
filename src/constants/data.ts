...
export const AssessmentQuestions = [
  ...
  {
    id: 2,
    question: "In probability, if two events A and B are independent, then P(A ∩ B) is:",
    options: ["P(A) * P(B)", "P(A) + P(B)", "P(A) - P(B)", "P(A) / P(B)"]
  },
  {
    id: 3,
    question: "Which of the following is a primary key in relational database design?",
    options: ["Unique column identifier", "Non-unique column", "Foreign key", "Indexed column"]
  },
  {
    id: 4,
    question: "In a control system, the transfer function represents the relation between:",
    options: ["Input and output", "Time and frequency", "Current and voltage", "Feedback and input"]
  },
  {
    id: 5,
  ...
  },
  {
    ...
    options: ["Round Robin", "First Come First Serve", "Shortest Job Next", "Multilevel Queue"]
  },
  {
    id: 7,
    question: "In C programming, which of the following is used to define a constant?",
  ...
  },
  {
    ...
    options: ["Amplification", "Rectification", "Voltage regulation", "Signal modulation"]
  },
  {
    id: 12,
    question: "In object-oriented programming, encapsulation is achieved using:",
    options: ["Classes and objects", "Inheritance", "Polymorphism", "Abstraction"]
  },
  {
    id: 13,
    question: "Which one of the following methods is used to solve linear equations?",
    options: ["Gaussian Elimination", "Euler’s Method", "Runge-Kutta Method", "Newton-Raphson Method"]
  },
  {
    id: 14,
    question: "In digital electronics, the output of an XOR gate is HIGH if:",
    options: ["Both inputs are LOW", "Both inputs are HIGH", "The inputs are the same", "The inputs are different"]
  },
  {
    id: 15,
